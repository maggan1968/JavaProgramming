...
public class PatientInformation {
    public static void main(String[] args) {
        ...
        String contacts="Contacts: "+"work phone number - "+workPhoneNumber+", personal phone number - "+personelPhoneNumber+", email: "+email;
...
Full name: May, James Address: 7925 Jones Branch Dr, McLean, VA 22102
