...
public class Build_In_Functional_Interface {
    ...
    public static void main(String[] args) {
        ...
        Predicate<String>isPalindrome = (p) -> {
            ...
            return reverse.equalsIgnoreCase(p);// return boolean to the end
        };
        ...
        // remove palindrome from this list
...
*/
        ...
        employees.addAll(Arrays.asList("Anel Adilbayeva","Aygun Abbasova Jarullah", "Malgorzata Altunsayar","Wojciech Kowalczyk"));
        ...
        //create a function that can return the maximum number an int array

        //create a function that can swap the first and last element of an array

        //create a function that can reverse an array and return it
