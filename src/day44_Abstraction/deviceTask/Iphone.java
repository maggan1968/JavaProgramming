...
public abstract class Iphone extends Phone implements AppleApps{
    public Iphone(String brand, String model, double price, String color, String size) {
    ...
    @Override
    public void unlock() {
        System.out.println("Siri say: to unlock");
