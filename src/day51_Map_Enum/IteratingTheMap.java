...
public class IteratingTheMap {
    public static void main(String[] args) {
        ...
        for (String eachKey : keys) {// name of each student(Margie Maria Ali Olga Serkan Ozan)
         //   System.out.println(eachKey +" : " + students.get(eachKey));//each value (49,85,85,96,86,96)
...
*/;
        ...
        System.out.println("--------------------------------------------------------");
// find the min & max number in Map
